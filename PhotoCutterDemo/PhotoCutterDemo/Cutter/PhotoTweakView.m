             ...
             maxRotationAngle:(CGFloat)maxRotationAngle
{
    if (self = [super init]) {
        ...
        if (bounds.size.height < SCREEN_WIDTH *14/25) {
            scaleY = SCREEN_WIDTH *14/25 /image.size.height ;
            
            bounds = CGRectMake(0, 0, image.size.width *scaleY, image.size.height*scaleY);
        }
...
#endif
        _cropView = [[CropView alloc] initWithFrame:CGRectMake(0, 100, SCREEN_WIDTH, SCREEN_WIDTH * 14 / 25)];
        ...
        _scrollView.contentInset = UIEdgeInsetsMake(_cropView.frame.origin.y - self.scrollView.frame.origin.y , (bounds.size.width - SCREEN_WIDTH) / 2,  self.scrollView.bottom- _cropView.bottom,  (bounds.size.width - SCREEN_WIDTH) / 2);
...
//        self.cropView.center = self.scrollView.center;
        ...
        self.scrollView.contentInset = UIEdgeInsetsMake(self.cropView.frame.origin.y - self.scrollView.frame.origin.y , (self.scrollView.width - SCREEN_WIDTH) / 2,  self.scrollView.bottom- self.cropView.bottom,  (self.scrollView.width- SCREEN_WIDTH) / 2);
